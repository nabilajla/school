 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <ul class="nav navbar-nav ml-auto">
                <div class="dropdown">
                    <button class="btn btn-primary dropdown-toggle" type="button" id="Drop2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    {{ trans('main-sidebar.change_Language') }}
                    </button>
